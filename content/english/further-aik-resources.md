...
After doing the air detective activity and maintaining the health diary, you may want to talk to your GP about air pollution and its impacts on health. Despite having evidence, talking to GP might be challenging.

Air is Kin addresses how communities interact with primary care through resources like the "Approaching Your GP On Air Pollution-Related Health Concerns" booklets (available for both adults and children). Because current healthcare systems often fail to record air pollution's health impacts in real time, these guides equip people to use their GPs as an institutional "witness." They provide strategies for presenting health diaries and symptom patterns so doctors can formally recognize and connect everyday illnesses to local environmental pollution.

## Sacrifice Zone
https://london.sciencegallery.com/vs-artworks/air-is-kin

The Air is Kin framework defines an urban "Sacrifice Zone" as a geographic area or neighbourhood where pollution has been deemed legally or politically acceptable by structural planning and commercial policy. In these zones, a piece of land and its community are essentially ‘sacrificed’ under the false narrative that the pollution is a necessary trade-off for the greater economic good. To combat the legal loopholes of standard definitions, the project uses geospatial and physiological data to re-define these zones at the point of ‘first harm’, allowing communities to hold industrial polluters accountable early on. Although Hounslow is not listed under sacrifice zones, the concept is useful to understand in order to withstand air pollution and change the narrative.
